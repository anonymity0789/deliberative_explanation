...
def main():
    ...
    for j in range(REPEAT_NUM):
        ...
        }, filename='./cub200/checkpoint_pretrain_res50.pth.tar')
        sio.savemat('./cub200/all_train_acc_epoch_for_pretrain.mat', {'all_train_acc_epoch': all_train_acc_epoch})
        sio.savemat('./cub200/all_test_acc_epoch_for_pretrain.mat', {'all_test_acc_epoch': all_test_acc_epoch})
