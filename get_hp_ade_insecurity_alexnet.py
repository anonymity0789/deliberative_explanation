...
parser.add_argument('--resume', default='./ade/checkpoint_alexnet_hp1.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    np.save('./ade/hardness_scores_te_alexnet.npy', hardness_scores_te)
    np.save('./ade/hardness_te_idx_each_alexnet.npy', hardness_te_idx_each)

    hardness_scores_te = np.load('./ade/hardness_scores_te_alexnet.npy')
    hardness_te_idx_each = np.load('./ade/hardness_te_idx_each_alexnet.npy')
    ...
    print(IOU)
    np.save('./ade/hardness_predictor_alexnet_lastConv_IOU_multi1.npy', IOU)
