...
parser.add_argument('--resume', default='./cub200/checkpoint_res50_hp1.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    np.save('./cub200/all_correct_res_te_multi1.npy', all_correct_te)
    np.save('./cub200/all_predicted_res_te_multi1.npy', all_predicted_te)
    np.save('./cub200/all_class_dis_res_te_multi1.npy', all_class_dis_te)

    all_correct_te = np.load('./cub200/all_correct_res_te_multi1.npy')
    all_predicted_te = np.load('./cub200/all_predicted_res_te_multi1.npy')
    all_class_dis_te = np.load('./cub200/all_class_dis_res_te_multi1.npy')


    hardness_scores_te, hardness_te_idx_each = save_predicted_hardness(train_loader, val_loader, model_ahp_trunk, model_ahp_hp)
    np.save('./cub200/hardness_scores_te_multi1.npy', hardness_scores_te)
    np.save('./cub200/hardness_te_idx_each_multi1.npy', hardness_te_idx_each)

    hardness_scores_te = np.load('./cub200/hardness_scores_te_multi1.npy')
    hardness_te_idx_each = np.load('./cub200/hardness_te_idx_each_multi1.npy')
...
def insecurity_extraction(val_loader, grad_cam_hp, grad_cam_cls, imglist, topKcls, com_extracted_attributes, part_Locs, topK_prob_predicted_classes, remaining_mask_size_pool):
    ...
    insecurities_info = './cub200/insecurities_info.txt'
