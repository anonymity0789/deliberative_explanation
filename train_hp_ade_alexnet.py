...
parser.add_argument('--resume', default='./ade/checkpoint_pretrain_alexnet.pth.tar', type=str, metavar='PATH',
    ...
    for j in range(REPEAT_NUM):
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            if AUC > threshold:
                ...
                }, filename='./ade/checkpoint_alexnet_hp.pth.tar')
...
def train_ap(train_loader, model_main, model_ahp_trunk, model_ahp_hp, optimizer_m, optimizer_ahp_trunk, optimizer_ahp_hp, epoch, criterion_f):
    ...
    for i, (input, target, index) in enumerate(train_loader):
        ...
        loss_a, _, _ = opposite_loss(predicted_labels, predicted_hardness_scores, target, criterion_f, press=5)
