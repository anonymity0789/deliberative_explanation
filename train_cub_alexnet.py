...
parser.add_argument('--gpu', default='1,2,3', help='index of gpus to use')
...
def main():
    ...
    for j in range(REPEAT_NUM):
        ...
        }, filename='./cub200/checkpoint_pretrain_alexnet.pth.tar')
        sio.savemat('./cub200/all_train_acc_epoch_for_pretrain_alexnet.mat', {'all_train_acc_epoch': all_train_acc_epoch})
        sio.savemat('./cub200/all_test_acc_epoch_for_pretrain_alexnet.mat', {'all_test_acc_epoch': all_test_acc_epoch})
