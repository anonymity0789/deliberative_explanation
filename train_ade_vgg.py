...
def main():
    ...
    for j in range(REPEAT_NUM):
        ...
        }, filename='./ade/checkpoint_pretrain_vgg16_bn.pth.tar')
        sio.savemat('./ade/all_train_acc_epoch_for_pretrain_vgg16_bn.mat', {'all_train_acc_epoch': all_train_acc_epoch})
        sio.savemat('./ade/all_test_acc_epoch_for_pretrain_vgg16_bn.mat', {'all_test_acc_epoch': all_test_acc_epoch})
