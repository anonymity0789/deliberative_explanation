...
def main():
    ...
    np.save('./cub200/entropy_vgg16bn_layer42_insecurity_score_multi1.npy', insecurity_score)
    np.save('./cub200/entropy_vgg16bn_layer42_precision_multi1.npy', precision)
