...
parser.add_argument('--resume', default='./cub200/checkpoint_alexnet_hp1.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    np.save('./cub200/all_correct_alexnet_te_multi1.npy', all_correct_te)
    np.save('./cub200/all_predicted_alexnet_te_multi1.npy', all_predicted_te)
    np.save('./cub200/all_class_dis_alexnet_te_multi1.npy', all_class_dis_te)

    all_correct_te = np.load('./cub200/all_correct_alexnet_te_multi1.npy')
    all_predicted_te = np.load('./cub200/all_predicted_alexnet_te_multi1.npy')
    all_class_dis_te = np.load('./cub200/all_class_dis_alexnet_te_multi1.npy')


    hardness_scores_te, hardness_te_idx_each = save_predicted_hardness(train_loader, val_loader, model_ahp_trunk, model_ahp_hp)
    np.save('./cub200/hardness_scores_te_alexnet_multi1.npy', hardness_scores_te)
    np.save('./cub200/hardness_te_idx_each_alexnet_multi1.npy', hardness_te_idx_each)

    hardness_scores_te = np.load('./cub200/hardness_scores_te_alexnet_multi1.npy')
    hardness_te_idx_each = np.load('./cub200/hardness_te_idx_each_alexnet_multi1.npy')
    ...
    grad_cam_hp = GradCam_hp(model_ahp_trunk, model_ahp_hp, target_layer_names=["11"], use_cuda=True)
    grad_cam_cls = GradCam_cls(model_main, target_layer_names=["11"], use_cuda=True)
    ...
    np.save('./cub200/hardness_predictor_alexnet_lastConv_recall_multi1.npy', recall)
    np.save('./cub200/hardness_predictor_alexnet_lastConv_precision_multi1.npy', precision)
