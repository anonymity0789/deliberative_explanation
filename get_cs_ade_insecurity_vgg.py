...
parser.add_argument('--resume', default='./ade/checkpoint_pretrain_vgg16_bn1.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    np.save('./ade/all_correct_te_cls_vgg16_multi1.npy', all_correct_te)
    np.save('./ade/all_predicted_te_cls_vgg16_multi1.npy', all_predicted_te)
    np.save('./ade/all_entropy_te_cls_vgg16_multi1.npy', all_entropy_te)
    np.save('./ade/all_class_dis_te_cls_vgg16_multi1.npy', all_class_dis_te)

    all_correct_te = np.load('./ade/all_correct_te_cls_vgg16_multi1.npy')
    all_predicted_te = np.load('./ade/all_predicted_te_cls_vgg16_multi1.npy')
    all_entropy_te = np.load('./ade/all_entropy_te_cls_vgg16_multi1.npy')
    all_class_dis_te = np.load('./ade/all_class_dis_te_cls_vgg16_multi1.npy')


    hardness_scores_te = 1 - np.max(all_class_dis_te, axis=1)
    hardness_te_idx_each = np.arange(0, 1984)
    ...
    print(IOU)
    np.save('./ade/confidence_score_vgg16_layer42_IOU_multi1.npy', IOU)
