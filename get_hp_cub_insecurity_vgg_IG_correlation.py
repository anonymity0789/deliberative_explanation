...
def main():
    ...
    np.save('./cub200/hardness_predictor_vgg16bn_layer42_IG_insecurity_score_multi1.npy', insecurity_score)
    np.save('./cub200/hardness_predictor_vgg16bn_layer42_IG_precision_multi1.npy', precision)
