...
def main():
    ...
    IOU = insecurity_extraction(val_hard_loader, integrad_hp, integrad_cls,
    ...
    np.save('./ade/hardness_predictor_vgg16_layer42_IG_IOU_multi1.npy', IOU)
...
def insecurity_extraction(val_loader, integrad_hp, integrad_cls, imglist, topKcls, com_extracted_attributes, seg_list, topK_prob_predicted_classes, remaining_mask_size_pool):
    ...
    for i, (input, target, index) in enumerate(val_loader):
        ...
        classifier_heatmaps = integrad_cls(input, 1040, topK_prob_predicted_classes[i, :], refer_img, 50)
