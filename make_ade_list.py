...
# image = misc.imread('./ADEChallengeData2016/annotations/training/ADE_train_00000002.png')
# print (image.shape)
# print (image.dtype)

# load labels
scene_categories_tr = './ADEChallengeData2016/sceneCategories_tr.txt'
scene_categories_val = './ADEChallengeData2016/sceneCategories_val.txt'
...
#         img_path_list_tr.append('/data6/peiwang/datasets/ADEChallengeData2016/images/training/'+img_name+'.jpg')
#         img_label_list_tr.append(img_label)
#
# with open(scene_categories_val, 'r') as rf:
#     for line in rf.readlines():
#         img_name, img_label = line.strip().split()
#         img_path_list_val.append('/data6/peiwang/datasets/ADEChallengeData2016/images/validation/'+img_name+'.jpg')
#         img_label_list_val.append(img_label)

with open(scene_categories_tr, 'r') as rf:
    for line in rf.readlines():
        img_name, img_label = line.strip().split()
        img_path_list_tr.append('./ADEChallengeData2016/images/training/' + img_name + '.jpg')
        img_label_list_tr.append(img_label)

with open(scene_categories_val, 'r') as rf:
    for line in rf.readlines():
        img_name, img_label = line.strip().split()
        img_path_list_val.append('./ADEChallengeData2016/images/validation/' + img_name + '.jpg')
        img_label_list_val.append(img_label)
...
ADE_gt_tr_val = './ADEChallengeData2016/ADE_gt_tr_val.txt'
num_tr_val = 0
...
ADE_gt_val = './ADEChallengeData2016/ADE_gt_val.txt'
num_val = 0
...
ADE_label_name = './ADEChallengeData2016/ADE_label_name.txt'
num_name = 0
