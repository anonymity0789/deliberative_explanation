...
def main():
    ...
    grad_cam_hp = GradCam_hp(model_ahp_trunk, model_ahp_hp, target_layer_names=["12"], use_cuda=True)
    grad_cam_cls = GradCam_cls(model_main, target_layer_names=["12"], use_cuda=True)
    ...
    print(IOU)
    np.save('./ade/hardness_predictor_vgg16bn_layer12_IOU_multi1.npy', IOU)
